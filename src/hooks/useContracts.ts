...
export function useMultiplePoolContracts(poolAddresses: `0x${string}`[]) {
  // Temporarily simplified to avoid TypeScript complexity issues
  // TODO: Implement proper multi-contract calls once we have pools deployed
